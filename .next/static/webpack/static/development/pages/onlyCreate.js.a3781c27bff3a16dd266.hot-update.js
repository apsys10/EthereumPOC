...
function (_Component) {
  ...
  function OnlyCreate() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "componentDidMount", function () {
      axios__WEBPACK_IMPORTED_MODULE_12___default.a.get("https://donations-ffcdf.firebaseio.com/donations.json").then(function (res) {
        ...
        for (var _key2 in fetched) {
          if (fetched[_key2].CampignName == "Paypal") {
            console.log(fetched[_key2]);
          }
        }

        arr = fetched.map(function (v, i) {
...
//# sourceMappingURL=onlyCreate.js.a3781c27bff3a16dd266.hot-update.js.map