...
function (_Component) {
  ...
  function Info() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "dis", function () {
      if (parseInt(_this.state.donation) < mindollars) {
        document.getElementById('pay').dis;
      }
    });
...
//# sourceMappingURL=index2.js.0b856fc8f8c9ce562d96.hot-update.js.map