        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              axios__WEBPACK_IMPORTED_MODULE_10___default.a.get('https://min-api.cryptocompare.com/data/price?fsym=ETH&tsyms=BTC,USD,EUR').then(function (res) {
  ...
  _createClass(Info, [{
    ...
    value: function render() {
      ...
      if (this.state.donation < this.state.currentRate && this.state.touched) {
        ...
        }, "You won't be an approver if you pay less than minimum contribution. Currently ", this.state.currentRate);
        console.log(typeof min === "undefined" ? "undefined" : _typeof(min));
      } else {
        message = null;
      }
...
//# sourceMappingURL=index2.js.06f5cb125184882f4f7f.hot-update.js.map