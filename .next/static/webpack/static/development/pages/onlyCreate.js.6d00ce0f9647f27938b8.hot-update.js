  ...
  function OnlyCreate() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "componentDidMount", function () {
      axios__WEBPACK_IMPORTED_MODULE_12___default.a.get("https://donations-ffcdf.firebaseio.com/donations.json").then(function (res) {
        console.log("response data", res.data.LVmVR7unylNUsy7GCcZ); // let data;
        // data = res.data.filter((v) =>
        // {
        //   return v.CampaignName == "Paypal"
        // });
        // console.log(data);
      });
    });
...
//# sourceMappingURL=onlyCreate.js.6d00ce0f9647f27938b8.hot-update.js.map