...
function (_Component) {
  ...
  _createClass(OnlyCreate, [{
    ...
    //      const accountInfo = this.props.query;
    //     const accounts = await web3.eth.getAccounts();
    //     this.setState({campaigns:campaigns, accountInfo: accountInfo, accounts:accounts})
    // }
    // removeCamp = async (index) =>
    // {
    //   console.log("factory", factory);
    //   console.log(typeof index)
    //   try {
    //     await factory.methods.remove(index).call();
    //   const campaigns1 = this.state.campaigns.splice(index ,1);
    //   console.log(campaigns1)
    //   } catch (error) {
    //     console.log(error);
    //   }
    //   //console.log("all Campaigns", campaigns1);
    // }
...
//# sourceMappingURL=onlyCreate.js.f74c4d938d824324fc9e.hot-update.js.map