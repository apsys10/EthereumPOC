...
function (_Component) {
  ...
  _createClass(Info, [{
    ...
    value: function render() {
      ...
      if (this.state.donation < this.state.currentRate && this.state.touched) console.log("donating now", this.state.donation);
...
//# sourceMappingURL=index2.js.ccd86a80251ee77b86c6.hot-update.js.map