...
function (_Component) {
  ...
  _createClass(Notify, [{
    ...
    value: function render() {
      console.log("payment in notify ", this.props.payment);

      if (this.props.visible) {
        if (this.props.data) return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          style: {
            marginLeft: '80px',
            marginRight: '80px',
            marginTop: '80px'
...
//# sourceMappingURL=index2.js.a211e7e2d95270de0454.hot-update.js.map